# Build This App — AI Study Buddy Feature Module

> **Level app project** (not a toy snippet). Complete this after the level theory/exercises.

**Time:** 8–12 hours  
**Why it matters:** AI features are everywhere in 2026 job posts.

---

## Product

You are building: **AI Study Buddy Feature Module**
...
1. Follow Level 18 theory for provider choice
2. Isolate AI client in data/
3. Never commit keys

## Definition of done

Demo: ask Flutter question, get answer in app

## After this

Add AI trip summary to Ride Hailing stretch
