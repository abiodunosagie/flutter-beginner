...
# Build This App — Test-Harden Your ShopCart App

> **Level app project** (not a toy snippet). Complete this after the level theory/exercises.

**Time:** 6–10 hours  
**Why it matters:** Tests are how mid-level devs prove quality.

---

## Product

You are building: **Test-Harden Your ShopCart App**

## Acceptance checklist

- [ ] Unit tests: cart total, qty merge
- [ ] Widget test: add to cart updates badge
- [ ] Golden optional
- [ ] CI-friendly flutter test script in README

## Steps

1. Open Level 06 cart app
2. Extract pure cart logic if needed
3. Write tests under test/
4. Aim >70% on cart domain files
...
Add tests to Chat or Ride fare calculator
